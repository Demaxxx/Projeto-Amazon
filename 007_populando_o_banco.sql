...
(2, '2026-06-15'), -- Pedido ID 2: Feito pelo Edimax (Cliente 2)
(2, '2026-07-01'); -- Pedido ID 3: Feito pelo Edimax de novo (comprou em datas diferentes)
...
-- No Pedido 3 (do Edimax): Ele comprou 1 livro Clean Code (Produto 4)
INSERT INTO item_pedido (FK_id_pedido, FK_id_produto, quantidade, preco_unitario) VALUES 
(3, 4, 1, 95.00);
...
-- O Pedido 3 foi feito via Boleto. Note que status_pagamento está FALSE porque ainda aguarda a compensação do banco,
...
(3, 'Boleto Bancário', FALSE, 95.00, '2026-07-05', 'TX-BOL-9920112');
...
-- Pedido 2 (do Edimax): Já saiu do centro de distribuição e o motorista está na rua fazendo as rotas (data_entrega está NULL).
INSERT INTO amazon_entrega (nome_motorista, id_motorista, cnh, placa_veiculo, FK_id_pedido, data_saida, data_entrega, status_entrega) VALUES 
('Roberto Souza', 102, '98765432101', 'XYZ9G99', 2, '2026-06-16', NULL, 'Em trânsito');

-- Pedido 3 (do Edimax): Como o pagamento do Boleto ainda está falso (pendente), o sistema de logística trava 
-- os dados do motorista/veículo e deixa o status congelado aguardando liberação financeira.
INSERT INTO amazon_entrega (nome_motorista, id_motorista, cnh, placa_veiculo, FK_id_pedido, data_saida, data_entrega, status_entrega) VALUES 
(NULL, 0, 'N/A', 'N/A', 3, NULL, NULL, 'Pendente');